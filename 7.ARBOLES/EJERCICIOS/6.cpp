/*
6.	Escriba un método que imprima todos los datos de los ascendientes que 
estén vivos de un individuo cuyos datos genealógicos fueron almacenados 
en un árbol binario.
*/
...
public:
    ...
    void ImprimeAscendientesVivos(NodoArbol *);
    void ImprimeAscendientesVivos(Individuo dato);
};
...
void ArbolBinBus::ImprimeAscendientesVivos(NodoArbol* nodo)
{   
    if(nodo->Info.vivo) {
        cout << endl << nodo->Info << endl;
    }
    if(nodo->HijoIzq != NULL) {
        ImprimeAscendientesVivos(nodo->HijoIzq);
    }
    if(nodo->HijoDer != NULL) {
        ImprimeAscendientesVivos(nodo->HijoDer);
    }
}

void ArbolBinBus::ImprimeAscendientesVivos(Individuo dato)
{
    NodoArbol* nodo = Busqueda(Raiz, dato);
    ImprimeAscendientesVivos(nodo);
}
...
int main() 
{
    ...
    individuos.ImprimeAscendientesVivos(Individuo("Ignacio", 23, 'M', true));
